...
def plt_rps(types:list,
    ...
    plot_rpss(llm_datas,save_dir=save_dir,
                types=types,
                group_name="all")
        

def plot_rpss(llm_datas,
               types:list,
               group_name:str,
               save_dir:str = "evaluate/article/distortion"):
    ...
    fig.text(0.02, 0.5, "   $/text{RPS }_{/text{year}}$/n(standard deviations)", va='center', rotation='vertical', fontsize=22)
...
if __name__=="__main__":
   plt_rps(["country_core","country_used"],
               "evaluate\Graph\graph8")
