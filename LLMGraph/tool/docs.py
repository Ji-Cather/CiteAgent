...
def format_document(doc: Document, 
    ...
    missing_metadata = set(prompt.input_variables).difference(doc_infos)
    ...
    document_info = {k: doc_infos[k] for k in prompt.input_variables}
    if "no_cite_time" in experiment:
